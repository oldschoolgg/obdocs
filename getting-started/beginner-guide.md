...
Equip the best slash attack gear you have in your melee setup. This can be done by doing `+autoequip melee attack slash`. Kill baby dragons (black/blue) with `+k baby blue dragon`until you have the bones for 43 prayer. Then use `+offer dragon` to train the skill to 43.\
\
