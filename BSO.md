...
- Sea Kraken:
The Sea Kraken is a solo boss which drops a lot of food items and seeds. It requires range attack and magic defence gear in your range setup. It also drops the fish sack which boosts fishing. 

- Malygos:
Malygos is a solo boss which has some rare abyssal gear drops. It requires 999 qp kill and an anti dragon shield or an abyssal cape. It drops visages, the dragon hunter lance, a unique pet, and abyssal items.
